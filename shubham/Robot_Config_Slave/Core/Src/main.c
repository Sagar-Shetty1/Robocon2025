...
// controller
int32_t cro, squ, tri, cir, up, down, left, right, ll1, rr1, ll2, rr2, rL, rR;
...
// imu
float yaw = 0, pitch = 0, q0 = 0, q1 = 0, q2 = 0, q3 = 0; //yaw and pitched are physically interchanged because of imu orientation
