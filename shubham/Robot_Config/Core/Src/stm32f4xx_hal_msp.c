...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB4     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(Encoders3_A_GPIO_Port, Encoders3_A_Pin);

    HAL_GPIO_DeInit(Encoders3_B_GPIO_Port, Encoders3_B_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, Encoders4_A_Pin|Encoders4_B_Pin);
